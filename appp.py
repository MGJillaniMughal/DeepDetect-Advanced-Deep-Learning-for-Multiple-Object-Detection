...
# Scaling factor for bounding boxes (e.g., 0.8 for 80% size)
scale_factor = 0.8

# Draw bounding box definition
def draw_bounding_box(im, score, label, xmin, ymin, xmax, ymax, index, num_boxes):
    """ Draw a bounding box with scaling. """
    # Scale the bounding box coordinates
    xmin, ymin, xmax, ymax = [int(coord * scale_factor) for coord in [xmin, ymin, xmax, ymax]]
